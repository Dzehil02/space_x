...
//                         <p className="block-text__subtitle block-text__subtitle--big">
...
//                         <h2 className="block-text__title block-text__title--space">
//                             Space is not just stars and planets
//                         </h2>
//                         <p className="block-text__subtitle">
//                             {' '}
//                             <span className="block-text__subtitle--space">Go on a space adventure</span>
//                             <span className="block-text__subtitle--majestic"> it is a majestic journey to</span>{' '}
//                         </p>
//                         <a href="./" className="block-text__button button button--outline">
//                             Learn more
//                         </a>
                ...
                <div className="offers__content">
                    {cardData.map((data, index) => (
                        <Card
                            ...
                            subtitleSpan={data.subtitleSpan}
                            linkText={data.linkText}
                            isBig={data.isBig}
                            bgClass={`block-text ${data.bgClass}`}
                        />
                    ))}
                </div>
            </div>
